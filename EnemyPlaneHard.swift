...
class EnemyPlaneHard: EnemyPlane {
    override init() {
        super.init()
        
        self.texture = SKTexture(imageNamed: "EnemyPlaneHard")
        
        self.score = 3
        
        self.healthPointNode = HealthPoint(healthPoint: 40)
    ...
    override func fireBullet() {
        self.fireBulletAtAngle(.pi / 12 * 13, delay: 0)
        ...
        self.fireBulletAtAngle(.pi / 12 * 23, delay: 0)
    }
